...
router.post("/", partnerUpload.single("logo"), handleMulterError, compressionPresets.thumbnail, validatePartner, createPartner);
router.put("/:id", partnerUpload.single("logo"), handleMulterError, compressionPresets.thumbnail, validatePartner, updatePartner);
